...
const ViewDep = ()=>{
    ...
    const idData = Card.find((x)=>x.healthNo === viewId)
    ...
    return(
        ...
        <div className="layout-content">
            ...
            <div className="container">
                    <h1 style={{textAlign:"center"}} className={style.logo}>View Dependents</h1>
                    <hr />
                            <div className="row">
                                <div className="col">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">First Name</label>
                                        <input type="text" className={`form-control ${fnameValidate ? "error":""}`}  placeholder="John" value={fname} onChange={handleFname} readOnly/>
                                ...
                                <div className="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" className={`form-control ${lnameValidate ? "error":""}`}  placeholder="Doe" value={lname} onChange={handleLname} readOnly/>
                                ...
                                <select className={`form-select ${genValidate ? "error":""}`} aria-label="Default select example" value={gender} onChange={handleGen} disabled>
                            ...
                            <div className="row">
                                <div className="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" className={`form-control ${heiValidate ? "error":""}`}  placeholder="Enter your Height" value={height} onChange={handleHeight} readOnly/>
                                ...
                                <div className="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" className={`form-control ${weiValidate ? "error":""}`}  placeholder="Enter your Weight" value={weight} onChange={handleWeight} readOnly/>
                                ...
                                <div className="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" className={`form-control ${dobValidate ? "error":""}`} value={dob} onChange={handleDob} readOnly/>
                                        {dobErrMsg?.length > 0 && (
                            ...
                            <div className="row">
                                <div className="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" className={`form-control`}  placeholder="Enter your Email" value={email} onChange={handleEmail} readOnly/>
                                    </div>
                                </div>
                                <div className="col">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Phone Number(optional)</label>
                                        <input type="text" className={`form-control`}  placeholder="Enter your Phone no" value={phone} onChange={handlePhone} readOnly/>
                                    </div>
                                </div>
                                <div className="col">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Passport</label>
                                        <input type="text" className={`form-control ${passValidate ? "error":""}`}  placeholder="Enter your Passport no" value={passport} onChange={handlePass} readOnly/>
