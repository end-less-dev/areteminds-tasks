...
const Register = ()=>{
    ...
    return(
        <div className="main">
        <div class="container-fluid box" style={{width:"50%"}} >
        <h1 style={{textAlign:"center"}} className={style.logo}>Registration</h1>
            <div class="row" >
                <div class="col-md">
                    <div class="mb-3">
            ...
            <div class="row">
                    <div class="col-md">
                        <div class="mb-3">
                            ...
                            <input type="email" className={`form-control ${emailValidate? "error":""}`} id="exampleFormControlInput1" placeholder="example@gmail.com" onChange={handleEmail} required/>
